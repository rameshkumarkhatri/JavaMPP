...
public class Main {
	...
	private static <T> boolean contains3(List<T> list, T t, BiPredicate<? super T,? super T> eq) {
	...
	private static <T> boolean contains4(List<? extends T> list, T t, BiPredicate<? super T, ? super T> eq) {
		for(T ttt : list)
			if(eq.test(ttt, t))
				return true;
