...
public class Section {
	...
	public static Stream<String> streamSection(final Stream<String> stream, int m, int n) {
	    Stream<String> stringStream = stream.skip(m).limit(n);
        return stringStream; //implement
	}
